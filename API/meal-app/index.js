...
// variable évolutive
let meals = []; //fetchMeals s'occupe d'incrémenter notre data

// function pour fetché
...
// fonction pour affiché asynchrone
async function mealsDisplay() {
  ...
  if (meals === null) {
    ...
    // à chaque tout de map, tu m'exécutes la boucle for, pour chacune des recettes, il va aller chercher strIngredient1, ...2. ENsuite ce creer des sous-variables
